...
public class UserDetail implements Serializable {
    ...
    public UserDetail(User user) {
        this.created_at = user.getUserCreatedDate().toString();
        this.favorites_count = user.getUserFavoritesCount();
        this.followers_count = user.getUserFollowersCount();
        this.following_count = user.getUserFollowingCount();
        this.id = 0;
