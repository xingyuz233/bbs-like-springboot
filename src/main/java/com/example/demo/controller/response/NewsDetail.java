...
public class NewsDetail implements Serializable {
    ...
    public NewsDetail(News news) {
        ...
        this.title = news.getNewsTitle();
        this.created_at = df.format(news.getNewsPublishTime());
        this.updated_at = df.format(news.getNewsModifyTime());
        this.user = null;
        this.node_id = 0;
        this.node_name = "Android";
        this.last_reply_user_id = 0;
        this.last_reply_user_login = news.getNewsUserPhone();
        this.replied_at = news.getNewsLastReplyTime() == null? null: df.format(news.getNewsLastReplyTime());
        this.replies_count = news.getNewsReplyCount();
        this.address = news.getNewsAddress();
